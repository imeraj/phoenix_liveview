defmodule PentoWeb.Admin.DashboardLive.SurveyResults do
  @moduledoc false
  ...
  defp assign_products_with_average_ratings(
    ...
    assign(
      ...
      Catalog.get_products_with_average_ratings(age_group_filter)
    )
  end
  ...
  defp subtitle, do: "average start ratings per product"

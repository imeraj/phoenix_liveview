defmodule Pento.Catalog do
  ...
  def list_products_with_user_ratings(scope) do
    Product.Query.base()
    |> Product.Query.with_user_ratings(scope)
    |> Repo.all()
  end
  ...
  def get_products_with_average_ratings(filter) do
    case products_with_average_ratings(%{age_group_filter: filter}) do
      [] -> products_with_zero_ratings()
      products -> products
    end
  end
end
